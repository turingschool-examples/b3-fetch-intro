...
const fetchPalettes = (projectId) => {
  fetch( `https://b3-fetch-intro-server.herokuapp.com/api/v1/projects/${projectId}/palettes`)
    .then(response => response.json())
...
const postProject = () => {
  ...
  fetch('https://b3-fetch-intro-server.herokuapp.com/api/v1/projects', postPayload({ project_name: newProjectName }))
    .then(response => {
...
const postPalette = (body) => {
  fetch(`https://b3-fetch-intro-server.herokuapp.com/api/v1/projects/${body.project_id}/palettes`, postPayload(body))
    .then(response => response.json())
    .then(newPalette => {
...
const deleteSmallPalette = (event) => {
  ...
  fetch(`https://b3-fetch-intro-server.herokuapp.com/api/v1/palettes/${id}`, {
    method: 'DELETE',
  })
    .catch(error => {
      throw error;
...
const deleteProject = (event) => {
  ...
  fetch(`https://b3-fetch-intro-server.herokuapp.com/api/v1/projects/${id}`, {
    method: 'DELETE',
  })
    .catch(error => {
      throw error;
